export const translations = {
  da: {
    ...
    waitingShort: 'venter',
    waitingForTransfer: 'venter på overførsel',
    syncing: 'Synkroniserer',
    retrying: 'prøver igen',
    offlineShowingCached: 'Offline. Viser seneste gemte tal.',
    offlineCachePreparing: 'Gør offline klar',
    ...
    professionalHandoverHint: 'Brug kun rigtige navne i felterne for afsender og modtager. Navnene vises i historikken.',
    professionalNamesRequired: 'Brug rigtige navne på både afsender og modtager.',
    images: 'Billeder',
    saving: 'Gemmer...',
    ...
    handoverPublished: 'Overleveringen er gemt og kan nu ses af andre.',
    handoverLoadFailed: 'De nyeste overleveringer kunne ikke hentes. Kontrollér internetforbindelsen og prøv igen.',
    retry: 'Prøv igen',
    requiresInternet: 'Kræver internet',
    offlineDraftNotPublished: 'Ikke afleveret endnu – kræver internet.',
    imagesRequireInternet: 'Billeder kan tilføjes, når der igen er internet.',
    handoverDraftWaitingSingular: 'overlevering ikke afleveret',
    handoverDraftWaitingPlural: 'overleveringer ikke afleveret',
...
Skriv hvor tingene står.`,
    ...
    couldNotSaveRegistration: 'Registreringen kunne ikke gemmes på denne enhed.',
    ...
    estimateBasis: 'Beregnet med 2.000 kg pr. container og 1,90 kr. pr. kg madspild.',
    ...
    guests: 'Gæster',
    guestsInPeriod: 'Gæster i perioden',
    guestCountsByDate: 'Indtastede gæster pr. dato',
    noGuestCountsInPeriod: 'Der er ikke indtastet gæster i perioden.',
    ...
    passengerCountPlaceholder: 'Antal passagerer',
    crewCount: 'Crew',
    totalGuestsToday: 'Gæster i alt i dag',
    missingGuestDates: 'Mangler gæstetal på disse datoer',
    allGuestDatesComplete: 'Alle relevante datoer har gæstetal.',
  ...
  sv: {
    ...
    professionalHandoverHint: 'Använd endast riktiga namn i fälten för avsändare och mottagare. Namnen visas i historiken.',
    professionalNamesRequired: 'Använd riktiga namn på både avsändare och mottagare.',
    images: 'Bilder',
    saving: 'Sparar...',
    ...
    handoverPublished: 'Överlämningen har sparats och kan nu ses av andra.',
    handoverLoadFailed: 'De senaste överlämningarna kunde inte hämtas. Kontrollera internetanslutningen och försök igen.',
    retry: 'Försök igen',
    requiresInternet: 'Kräver internet',
    offlineDraftNotPublished: 'Inte överlämnad ännu – kräver internet.',
    imagesRequireInternet: 'Bilder kan läggas till när internetanslutningen är tillbaka.',
    handoverDraftWaitingSingular: 'överlämning inte överlämnad',
    handoverDraftWaitingPlural: 'överlämningar inte överlämnade',
    publishRequiresDraft:
...
Skriv var sakerna står.`,
    ...
    couldNotSaveRegistration: 'Registreringen kunde inte sparas på den här enheten.',
    ...
    estimateBasis: 'Beräknat med 2 000 kg per container och 1,90 kr. per kg matsvinn.',
    containerShort: 'container',
    category: 'Kategori',
    guestCountsNeedSql:
    ...
    kgInPeriod: 'Kg i perioden',
    guests: 'Gäster',
    guestsInPeriod: 'Gäster under perioden',
    guestCountsByDate: 'Registrerade gäster per datum',
    noGuestCountsInPeriod: 'Inga gäster har registrerats under perioden.',
    ...
    passengerCountPlaceholder: 'Antal passagerare',
    crewCount: 'Besättning',
    totalGuestsToday: 'Totalt antal gäster i dag',
    missingGuestDates: 'Gästtal saknas för dessa datum',
    allGuestDatesComplete: 'Alla relevanta datum har gästtal.',
  ...
  en: {
    ...
    waitingForTransfer: 'waiting to transfer',
    syncing: 'Syncing',
    retrying: 'trying again',
    offlineShowingCached: 'Offline. Showing the latest saved figures.',
    offlineCachePreparing: 'Preparing offline',
    ...
    professionalHandoverHint: 'Only use real names in the sender and recipient fields. The names are shown in the history.',
    professionalNamesRequired: 'Use real names for both the sender and recipient.',
    images: 'Images',
    saving: 'Saving...',
    ...
    handoverPublished: 'The handover has been saved and is now visible to others.',
    handoverLoadFailed: 'The latest handovers could not be loaded. Check the internet connection and try again.',
    retry: 'Try again',
    requiresInternet: 'Internet required',
    offlineDraftNotPublished: 'Not submitted yet – internet is required.',
    imagesRequireInternet: 'Images can be added when the internet connection is back.',
    handoverDraftWaitingSingular: 'handover not submitted',
    handoverDraftWaitingPlural: 'handovers not submitted',
...
Explain where things are located.`,
    ...
    couldNotSaveRegistration: 'The entry could not be saved on this device.',
    ...
    estimateBasis: 'Calculated using 2,000 kg per container and DKK 1.90 per kg of food waste.',
    containerShort: 'container',
    category: 'Category',
    ...
    guests: 'Guests',
    guestsInPeriod: 'Guests in the period',
    guestCountsByDate: 'Entered guests by date',
    noGuestCountsInPeriod: 'No guest counts have been entered for this period.',
    ...
    passengerCountPlaceholder: 'Number of passengers',
    crewCount: 'Crew',
    totalGuestsToday: 'Total guests today',
    missingGuestDates: 'Guest counts are missing for these dates',
    allGuestDatesComplete: 'All relevant dates have guest counts.',
